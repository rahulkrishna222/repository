...
<body class="body_bg">
	<div id="main">
	  ...
	  <br />
		...
		<br />
          <ul>
            <li> <h3><a href="login.jsp" ><strong>Sign In</strong></a> </h3>
            </li>
          </ul> 
		 ...
		 <br />
		<article class="col-1">
                	<a href="onlineUserList.html"><img class="img-border" src="images/banner1.png" alt=""></a>  <br />  </article> 
                <article class="col-1">
		...
		<br />
		<article class="col-1">
                	<a href="rules.jsp"><img src="images/banner2.png" alt="" width="290" height="149" class="img-border"></a>                </article>
          <p>
        </div>
        <div class="sidebar"> 
        <br />
		   <article class="col-2">
                	<a href="registration.jsp"><img src="images/banner3.png" alt="" width="290" height="149" class="img-border"></a>                </article>
       <p>
        </div>  
      </div>
      <div class="content">
...
Chess is a game played between two opponents on opposite sides of a board containing 64 squares of alternating colors. Each player has 16 pieces: 1 king, 1 queen, 2 rooks, 2 bishops, 2 knights, and 8 pawns. The goal of the game is to checkmate the other king. Checkmate happens when the king is in a position to be captured (in check) and cannot escape from capture. 
	 ...
	 <h3>
            <a href="about.jsp">Read more</a></h3>
		</div>
